...
export const LIBRARY: BuildingDef[] = [
  { id: "road", name: "Road", glyph: "═", baseC: 0xc49a5a, cost: { w: 1 }, regen: 0, unlock: 0, hp: 9999, decor: true, passableOwner: true, blocksMovement: false,
    blurb: "A walkable city road. Movement on roads and inside Wonder districts does not spend energy.", effect: "Walkable path. No energy spent while travelling on roads." },
  { id: "cottage", name: "Cottage", glyph: "⌂", baseC: 0xf6e7c8, cost: { w: 16, s: 6 }, regen: 0.06, maxE: 5, unlock: 0,
    use: { k: "rest", cd: 20, label: "Rest — restore ♥" }, blurb: "A glowing-window home. Rest inside to heal up.", effect: "Restores HP when used nearby." },
  ...
  { id: "quarry", name: "Quarry", glyph: "⛏", baseC: 0x8d897f, cost: { w: 6, s: 2 }, regen: 0.06, unlock: 0,
    prod: { s: 0.05 }, blurb: "Exposes fresh stone around the quarry every cycle. Upgrades improve stone yield from every rock on your owned territory.", effect: "Spawns rocks; upgrades increase owned-territory rock stone." },
