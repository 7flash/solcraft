...
export const BUILDING_POLISH: Record<string, BuildingPolish> = {
  ...
  quarry: {
    ...
    requires: "An empty captured tile you own.",
    produces: "Nearby rock nodes for stone used in construction and Landmarks.",
  ...
  worldwonder: {
    id: "worldwonder",
    purpose: "Landmark · shared public build funded with wood and stone that boosts coin production for everyone.",
  ...
  keep: {
    id: "keep",
    purpose: "Neutral Keep · coin target. Attack for coins, or leave it as a world target.",
    requires: "Stand beside it.",
    produces: "Coins when raided.",
    bestNear: "Scout before attacking; territory size comes from your $CRAFTS holding.",
  },
  npc: {
    id: "npc",
    purpose: "Traveler · attack for coins or trade when available.",
