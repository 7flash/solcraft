...
export const CORE_ACTIONS: CoreAction[] = [
  ...
  { key: 3, icon: "🔨", atlas: "build", label: "Hammer", click: "select-build", cursor: "hammer", help: "Hammer cursor: click a captured tile, then choose a building in the right panel." },
  ...
  { key: 5, icon: "⚑", atlas: "capture", label: "Capture", click: "capture-tool", cursor: "capture", help: "Capture cursor: click any free non-capital tile to claim it." },
  { key: 6, icon: "⚔", atlas: "sword", label: "Sword", click: "siege-tool", cursor: "sword", help: "Sword cursor: attack Keeps, buildings, or nearby settlers." },
];
