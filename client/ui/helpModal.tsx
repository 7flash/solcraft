...
export function HelpModalView() {
  return <div className="modal" style={{ width: "min(560px,94vw)" }}>
    ...
    <p className="tiny">{t("help.intro", "Use the bottom bar like a city-builder hotbar: gather, capture, build, demolish, and attack. Movement works in every action mode by clicking the world or using WASD, and energy limits heavy actions.")}</p>
    <p><span className="kbd">1</span> {t("help.hotkeys", "axe · pickaxe · hammer · shovel · capture · sword")}</p>
