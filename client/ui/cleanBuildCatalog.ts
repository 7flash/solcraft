...
const FALLBACK_CLEAN_BUILD_CHOICES: CleanBuildChoice[] = [
  ...
  { id: "quarry", name: "Quarry", icon: "⛏", role: "resource", text: "Creates nearby rock work. Stone is mainly used for capturing more land." },
  ...
  { id: "worldwonder", name: "World Wonder", icon: "★", role: "wonder", text: "Coin sink, reputation landmark, and permanent prestige teleport destination." },
];
